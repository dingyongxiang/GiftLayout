    ...
    fun init(attrs: AttributeSet?) {
        ...
        if (attrs != null) {
            ...
            if (a.hasValue(R.styleable.MagicTextView_innerShadowColor)) {
                this.addInnerShadow(a.getFloat(R.styleable.MagicTextView_innerShadowRadius, 0f),
                        a.getFloat(R.styleable.MagicTextView_innerShadowDx, 0f),
                        a.getFloat(R.styleable.MagicTextView_innerShadowDy, 0f),
                        a.getColor(R.styleable.MagicTextView_innerShadowColor, -0x1000000))
            }

            if (a.hasValue(R.styleable.MagicTextView_outerShadowColor)) {
                this.addOuterShadow(a.getFloat(R.styleable.MagicTextView_outerShadowRadius, 0f),
                        a.getFloat(R.styleable.MagicTextView_outerShadowDx, 0f),
                        a.getFloat(R.styleable.MagicTextView_outerShadowDy, 0f),
                        a.getColor(R.styleable.MagicTextView_outerShadowColor, -0x1000000))
            }

            if (a.hasValue(R.styleable.MagicTextView_strokecolor)) {
                val strokeWidth = a.getFloat(R.styleable.MagicTextView_strokewidth, 1f)
                val strokeColor = a.getColor(R.styleable.MagicTextView_strokecolor, -0x1000000)
                val strokeMiter = a.getFloat(R.styleable.MagicTextView_strokemiter, 10f)
